...
Демо: https://drive.google.com/file/d/1nOY8j0r3LN_6yehRmZrGG97Yeg5IRbme/view?usp=sharing
...
1.1) Исходный код приложения (архив: TableParseBeta.rar)
1.2) Дипломы, подтверждающие успешное прохождение теста на двадцатый чин всеми членами команды (архив: Certificates.zip)
1.3) Файл, который вы сейчас читаете (файл: README_RUS.txt)
1.4) Тот же файл на английском языке (файл: README_ENG.txt)
